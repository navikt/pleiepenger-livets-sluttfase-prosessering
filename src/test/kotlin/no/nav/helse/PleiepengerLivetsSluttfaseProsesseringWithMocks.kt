...
class PleiepengerLivetsSluttfaseProsesseringWithMocks {
    companion object {
        private val logger: Logger = LoggerFactory.getLogger(PleiepengerLivetsSluttfaseProsesseringWithMocks::class.java)
